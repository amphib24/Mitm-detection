...
#### Analyst Observation:
   - Over 1,500 packets were identified, rewuiring more targeted filtering for analysis.
...
#### Analyst Observation:
   - Most responses showed TTL vlaues ranging between 300-600 seconds, which is consistent with normal DNS behavior.
